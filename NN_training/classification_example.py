...
class ClassificationTrainer(Trainer):
    def __init__(self, *args, **kwargs):
        super().__init__("Classification", nn.CrossEntropyLoss(), *args, **kwargs)
...
tresnet18_cla_trainer = ClassificationTrainer(tresnet18, optimizer, lr_scheduler)

training_runner = TrainingRunner([tresnet18_cla_trainer], device)
out_dir = "/tmp/trainer_class_classifier_example"
training_runner.train(num_epochs, train_dl, test_dl, out_dir, dummy_run=True)
